        ...
        <div class="row">
            <div class="col-4">
                ...
                <form method="post" action="carro.php?nombre=Reloj_Negro&precio=45">
                    ...
                    <p>45€</p>
                    <input type="number" name="cantidad" value="1" size="2" id="rNegro" />
                    <input type="submit" value="Añadir al carro" class="btnAddAction btn" />
                </form>
            </div>
            <div class="col-4">
                <form method="post" action="carro.php?nombre=Reloj_Gris&precio=40">
                    ...
                    <p>40€</p>
                    <input type="number" name="cantidad" value="1" size="2" id="rGris" />
                    <input type="submit" value="Añadir al carro" class="btnAddAction btn" />
                </form>
            </div>
